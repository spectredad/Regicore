...
export const services = [
  ...
  { icon: "05", title: "Custom CRM", desc: "Every case tracked from intake through administration through closing, so nothing gets lost between paralegal and partner." },
  { icon: "06", title: "Lead-Gen Systems", desc: "A calendar full of the exact client profile your firm wants, not just anyone who clicked an ad." },
];
